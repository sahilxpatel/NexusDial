...
A pre-seeded demo account is created automatically during setup:

- **Mobile:** `+919800000001`
- **OTP:** `123456` (Hardcoded for all testing/demo accounts)
- Includes sample contacts, call history, and AI summaries
